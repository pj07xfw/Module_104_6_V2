...
DROP DATABASE IF EXISTS zzz_crud_tot_NOM_PRENOM_INFO1X_SUJET_104_2021;

-- Création d'un nouvelle base de donnée

CREATE DATABASE IF NOT EXISTS zzz_crud_tot_NOM_PRENOM_INFO1X_SUJET_104_2021;

-- Utilisation de cette base de donnée

USE zzz_crud_tot_NOM_PRENOM_INFO1X_SUJET_104_2021;
-- --------------------------------------------------------
